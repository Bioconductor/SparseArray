...
date: "Compiled `r doc_date()`;  Modified 7 June 2023"
package: SparseArray
vignette: |
...
```{r}
nzcount(svt1)  # number of nonzero elements in 'svt1'

## "Linear indices" of the nonzero elements in 'svt1':
nzwhich(svt1)

## "Array indices" (a.k.a. "array coordinates") of the nonzero elements
## in 'svt1':
...
## Operations from the 'Ops', 'Math', and 'Complex' groups

SVT\_SparseArray objects support operations from the 'Ops', 'Math',
