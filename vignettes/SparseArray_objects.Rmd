...
Multidimensional objects can be combined along any dimension:
```{r}
...
```{r}
m5 <- matrix(0L, nrow=5, ncol=6, dimnames=list(letters[1:5], LETTERS[1:6]))
m5[c(2, 6, 12:17, 22:30)] <- 101:117
svt5 <- SparseArray(m5)
