...
.test_crossprod1_SparseMatrix <- function(m, svt)
{
...
test_that("crossprod() on input objects of type \"double\"", {
    ...
    .test_crossprod1_SparseMatrix(m3, svt3)
