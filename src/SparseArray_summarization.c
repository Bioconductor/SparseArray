 ...
 * C_count_SVT_NAs()
 *
 * TODO: Implement COUNTNAS_OPCODE in Rvector_summarization.c and get
 * rid of this.
 */
...
/* --- .Call ENTRY POINT --- */
SEXP C_count_SVT_NAs(SEXP x_dim, SEXP x_type, SEXP x_SVT)
{
	R_xlen_t na_count;
 ...
 * C_anyNA_SVT()
 *
 * TODO: Implement ANYNA_OPCODE in Rvector_summarization.c and get
 * rid of this.
 */
...
/* --- .Call ENTRY POINT --- */
SEXP C_anyNA_SVT(SEXP x_dim, SEXP x_type, SEXP x_SVT)
{
